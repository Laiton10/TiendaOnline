...
<body>
    ...
    <form action="../Controlador/PeticionesClienteRegistro.php" method="post">
            ...
            <span style="color: red">
                  <?php
                  if(isset($_REQUEST["avisoID"])){
                      echo $_REQUEST["avisoID"];
                  }
                  ?>
            </span><br><br>
            ...
            <span style="color: red">
                <?php
                if(isset($_REQUEST["avisoPassword"])){
                    echo $_REQUEST["avisoPassword"];
                }
                ?></span><br><br>
